 ...
 */
final class Version20230421121115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD category_id INT DEFAULT NULL, ADD tag_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP category_id, DROP tag_id');
    }
}
