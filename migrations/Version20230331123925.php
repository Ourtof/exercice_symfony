 ...
 */
final class Version20230331123925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5A8A6C8D12469DE2 ON post (category_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5A8A6C8D12469DE2 ON post');
